...
Team.prototype.buildTeam = function() {
    inquirer
        .prompt({
            ...
            choices: ["Add Engineer", "Add Intern", "Exit and Build Team Portofolio"]
        })
        .then(({ action }) => {
...
Team.prototype.generateHtml = function() {
    console.log("Check out your new team profile!")
    
    return generatePage(this.manager, this.engineers, this.interns);   
}
